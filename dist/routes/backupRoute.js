...
router.use(auth_1.default, auth_1.requireSupervisor);
router.get('/', backupController_1.listBackupFiles);
router.post('/', backupController_1.createBackup);
router.get('/:filename', backupController_1.downloadBackup);
